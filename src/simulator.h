...
public:
    ...
    virtual bool Step(STATE& state, int action,
        int& observation, double& reward, std::ostream& ostr) const = 0;
    ...
    //// Self implemented: For POMCP model.
    virtual void Get_testing_Number_from_Action(double& testing_type, int& testing_number, int action_ID) const;
    virtual int Get_Rewards_Numerator_Denominator(double &numerator, double &denominator, STATE &state, int action) const; // For Debug Purpose.
