...
void SIMULATOR::Get_testing_Number_from_Action(double& testing_type, int& testing_number, int action_ID) const {
    cout<<"'Get_testing_Number_from_Action' function not implemented in the current SIMULATOR class."<< endl;
    abort();
}

int SIMULATOR::Get_Rewards_Numerator_Denominator(double &numerator, double &denominator, STATE &state, int action) const {
    cout<<"'Get_Rewards_Numerator_Denominator' function not implemented in the current SIMULATOR class."<< endl;
    abort();
}
